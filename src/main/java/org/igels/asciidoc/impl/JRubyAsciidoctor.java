...
// A copy of org.asciidoctor.internal.JRubyAsciidoctor used to fix https://github.com/asciidoctor/asciidoctorj/issues/102
public class JRubyAsciidoctor implements Asciidoctor {
    ...
    public static Asciidoctor create() {
    	return create(Arrays.asList("gems/asciidoctor-0.1.4/lib"));
